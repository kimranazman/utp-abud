-- Clean up orphaned data and fix foreign key constraints (corrected version)
...
BEGIN
  ...
  RAISE NOTICE 'Successfully updated % foreign key constraints to reference profiles table', constraint_count;
END $$;