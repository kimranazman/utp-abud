-- Create enhanced sample data for existing users with proper UUIDs
...
-- Create a sample conversation between the existing users using proper UUID
INSERT INTO public.conversations (id, title, is_group, created_at, updated_at, last_message_at) 
VALUES 
('b1b1b1b1-c2c2-d3d3-e4e4-f5f5f5f5f5f1'::uuid, 'Alumni Collaboration', false, '2025-08-29 10:00:00', '2025-08-29 15:30:00', '2025-08-29 15:30:00')
...
SELECT 'b1b1b1b1-c2c2-d3d3-e4e4-f5f5f5f5f5f1'::uuid, user_id, '2025-08-29 10:00:00', '2025-08-29 15:30:00'
FROM profiles 
WHERE full_name IN ('Si Apps', 'Khairul Imran bin Azman')
...
SELECT 
  'b1b1b1b1-c2c2-d3d3-e4e4-f5f5f5f5f5f1'::uuid,
  ...
  '2025-08-29 10:05:00'
WHERE NOT EXISTS (
  SELECT 1 FROM messages WHERE conversation_id = 'b1b1b1b1-c2c2-d3d3-e4e4-f5f5f5f5f5f1'::uuid
);
...
SELECT 
  ...
  '2025-08-29 12:30:00'
WHERE NOT EXISTS (
  SELECT 1 FROM messages WHERE conversation_id = 'b1b1b1b1-c2c2-d3d3-e4e4-f5f5f5f5f5f1'::uuid AND content LIKE 'Absolutely!%'
);
...
SELECT 
  ...
  '2025-08-29 15:30:00'
WHERE NOT EXISTS (
  SELECT 1 FROM messages WHERE conversation_id = 'b1b1b1b1-c2c2-d3d3-e4e4-f5f5f5f5f5f1'::uuid AND content LIKE 'Great! Let''s set up%'
);