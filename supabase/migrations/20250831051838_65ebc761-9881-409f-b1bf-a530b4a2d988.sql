-- Restore comprehensive seed data for the alumni network (corrected version)
...
-- Insert user education data (using correct programme_level values)
INSERT INTO public.user_education (user_id, programme_level, programme_name, graduation_year, is_primary) VALUES
('12345678-1234-1234-1234-123456789001', 'undergraduate', 'Bachelor of Science in Computer Science', 2018, true),
('12345678-1234-1234-1234-123456789002', 'postgraduate', 'Master of Business Administration', 2016, true),
('12345678-1234-1234-1234-123456789003', 'undergraduate', 'Bachelor of Arts in Marketing', 2019, true),
('12345678-1234-1234-1234-123456789004', 'undergraduate', 'Bachelor of Engineering', 2017, true),
('12345678-1234-1234-1234-123456789005', 'postgraduate', 'Master of Science in Data Science', 2020, true),
('12345678-1234-1234-1234-123456789006', 'undergraduate', 'Bachelor of Science in Finance', 2015, true),
('12345678-1234-1234-1234-123456789007', 'undergraduate', 'Bachelor of Fine Arts in Design', 2018, true),
('12345678-1234-1234-1234-123456789008', 'postgraduate', 'Master of Science in Environmental Science', 2019, true),
('12345678-1234-1234-1234-123456789009', 'postgraduate', 'Master of Arts in International Relations', 2016, true),
('12345678-1234-1234-1234-123456789010', 'undergraduate', 'Bachelor of Arts in Media Studies', 2021, true);
...
-- Insert user roles (alumni role for all)
